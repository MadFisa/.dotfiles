...
(doom! :input
       ...
       :emacs
       (dired +icons +fira)             ; making dired pretty [functional]
       tramp
       ...
       (tty +osc +kkp)               ; improve the terminal Emacs experience
       ...
       (org +dragndrop +gnuplot +journal +pandoc +pretty +roam)               ; organize your plain life in plain text
